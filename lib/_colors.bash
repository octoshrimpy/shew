...
# Example: RED=$(shew__nocolor '\033[0;31m')
shew__nocolor() {
...
shew__setupcolors() {
  ...
  C_BLACK="$(shew__nocolor '\033[0;30m')"
  C_RED="$(shew__nocolor '\033[0;31m')"
  C_GREEN="$(shew__nocolor '\033[0;32m')"
  C_YELLOW="$(shew__nocolor '\033[0;33m')"
  C_BLUE="$(shew__nocolor '\033[0;34m')"
  C_MAGENTA="$(shew__nocolor '\033[0;35m')"
  C_CYAN="$(shew__nocolor '\033[0;36m')"
  C_WHITE="$(shew__nocolor '\033[0;37m')"

  export C_BLACK C_RED C_GREEN C_YELLOW
  export C_BLUE C_MAGENTA C_CYAN C_WHITE

  # 🌈 Bright Foreground Colors
  C_B_BLACK="$(shew__nocolor '\033[0;90m')" # often used as gray
  C_B_RED="$(shew__nocolor '\033[0;91m')"
  C_B_GREEN="$(shew__nocolor '\033[0;92m')"
  C_B_YELLOW="$(shew__nocolor '\033[0;93m')"
  C_B_BLUE="$(shew__nocolor '\033[0;94m')"
  C_B_MAGENTA="$(shew__nocolor '\033[0;95m')"
  C_B_CYAN="$(shew__nocolor '\033[0;96m')"
  C_B_WHITE="$(shew__nocolor '\033[0;97m')"

  C_GRAY="$(shew__nocolor '\033[0;90m')"
  ...
  C_BG_BLACK="$(shew__nocolor '\033[40m')"
  C_BG_RED="$(shew__nocolor '\033[41m')"
  C_BG_GREEN="$(shew__nocolor '\033[42m')"
  C_BG_YELLOW="$(shew__nocolor '\033[43m')"
  C_BG_BLUE="$(shew__nocolor '\033[44m')"
  C_BG_MAGENTA="$(shew__nocolor '\033[45m')"
  C_BG_CYAN="$(shew__nocolor '\033[46m')"
  C_BG_WHITE="$(shew__nocolor '\033[47m')"
  ...
  C_BG_B_BLACK="$(shew__nocolor '\033[100m')"
  C_BG_B_RED="$(shew__nocolor '\033[101m')"
  C_BG_B_GREEN="$(shew__nocolor '\033[102m')"
  C_BG_B_YELLOW="$(shew__nocolor '\033[103m')"
  C_BG_B_BLUE="$(shew__nocolor '\033[104m')"
  C_BG_B_MAGENTA="$(shew__nocolor '\033[105m')"
  C_BG_B_CYAN="$(shew__nocolor '\033[106m')"
  C_BG_B_WHITE="$(shew__nocolor '\033[107m')"

  export C_BG_B_BLACK C_BG_B_RED C_BG_B_GREEN C_BG_B_YELLOW
  export C_BG_B_BLUE C_BG_B_MAGENTA C_BG_B_CYAN C_BG_B_WHITE

  # ✨ Styles
  C_BOLD="$(shew__nocolor '\033[1m')"
  C_DIM="$(shew__nocolor '\033[2m')"    # aka faint
  C_ITALIC="$(shew__nocolor '\033[3m')" # not widely supported
  C_UNDER="$(shew__nocolor '\033[4m')"
  C_BLINK="$(shew__nocolor '\033[5m')"
  C_REVERSE="$(shew__nocolor '\033[7m')"
  C_HIDDEN="$(shew__nocolor '\033[8m')"
  C_STRIKE="$(shew__nocolor '\033[9m')"

  export C_BOLD C_DIM C_ITALIC C_UNDER
  export C_BLINK C_REVERSE C_HIDDEN C_STRIKE

  # 🔄 Undo Styles
  C_UNBOLD="$(shew__nocolor '\033[21m')"
  C_UNDIM="$(shew__nocolor '\033[22m')"
  C_UNITALIC="$(shew__nocolor '\033[23m')"
  C_UNUNDER="$(shew__nocolor '\033[24m')"
  C_UNBLINK="$(shew__nocolor '\033[25m')"
  C_UNREVERSE="$(shew__nocolor '\033[27m')"
  C_UNHIDDEN="$(shew__nocolor '\033[28m')"
  C_UNSTRIKE="$(shew__nocolor '\033[29m')"

  export C_UNBOLD C_UNDIM C_UNITALIC C_UNUNDER
  export C_UNBLINK C_UNREVERSE C_UNHIDDEN C_UNSTRIKE

  # 🧼 Reset Colors
  C_RESET_FG="$(shew__nocolor '\033[39m')"
  C_RESET_BG="$(shew__nocolor '\033[49m')"
  C_NC="$(shew__nocolor '\033[0m')" # reset all (colors + styles)
